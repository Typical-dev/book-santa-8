...
//import SwipeableFlatlist from "../components/SwipeableFlatLst";
...
export default class NotificationScreen extends Component {
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <View style={{ flex: 0.9 }}>
                    {this.state.allNotifications.length === 0 ? (<View style={{ flex: 1, justifyContent: "center", alignItems: "center", }} >
    ...
    renderItem = ({ item, index }) => {
        return (<ListItem key={index}
            ...
            title={item.book_name} titleStyle={{
                color: "black",
                fontWeight: "bold"
            }}
