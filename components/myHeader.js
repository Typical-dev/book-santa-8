...
const BellIconWithBadge = (props) => {
    return (
        <View>
            <Icon name="bell" type="fount-awesome" color="#696969" size={25} onPress={() => {
         ...
         render() {
             return (
                 <Header leftComponent={<Icon name="bars" type="font-awesome" color="#696969" onPress={() => {
                     ...
                     rightComponent={<BellIconWithBadge {...props} />} centerComponent={{ text: props.title, style: { color: "#90A5A9", fontSize: 20, fontWeight: "bold" } }} backgroundColor="#CAF8FE" />
             )
         }
}
